...
#   Homepage Basic Info
    ...
    - Account section content switches between list of registered user accounts and account type descriptions
        ...
        - When array is empty (for new/non logged-in users), account type descriptions are displayed
        - When array is not empty (logged-in users with existing accounts), the accounts are displayed
