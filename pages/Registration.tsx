...
const Registration = () => {
    ...
    // The ValidUsernameandPassword function checks the validity of user input data
    const ValidUsernameandPassword = (str: string) => {
